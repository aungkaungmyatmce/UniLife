...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    postHomeController.scrollController.value = ScrollController()..addListener(postHomeController.loadMore);
  }

  @override
  void dispose() {
    postHomeController.scrollController.value.removeListener(postHomeController.loadMore);
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => postHomeController.isFirstLoadRunning.value
          ? const Center(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (_, index) => Card(
                ...
                child: ListTile(
                  title: Text(postHomeController.posts[index]['title']),
                  subtitle: Text(postHomeController.posts[index]['body']),
                ),
              ),
            ),
          ),
